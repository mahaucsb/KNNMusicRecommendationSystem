 ...
 * @author Maha
 */
public class KnnMapper extends MapReduceBase implements
		Mapper<LongWritable, PostingUserArrayWritable, LongWritable, NeighboursArrayWritable> {

	public HashMap<Long, PostingUser[]> SongUsersIndex;
