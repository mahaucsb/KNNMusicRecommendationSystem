...
/**
 * This class reads in a pre-processed input of LongWritables inverted index.
 * 
 */
public class InvertedMapRunner extends
		MapRunner<LongWritable, PostingUserArrayWritable, LongWritable, NeighboursArrayWritable> {

	private InvertedMapper mapper = new InvertedMapper();
	private HashMap<Long, PostingUser[]> SongUsersIndex = new HashMap<Long, PostingUser[]>();
